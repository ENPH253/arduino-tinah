...
#define PSTRU(s) (__extension__({static const unsigned char __c[] PROGMEM = (s); &__c[0];}))
...
#define GET_FAR_ADDRESS(var) pgm_get_far_address(var)
...
#define GET_FAR_ADDRESS(x) pgm_get_far_address(x)
